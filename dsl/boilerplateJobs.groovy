...
def gitUrlBuildroot = 'http://gitlab.eldan.lan/sw_host/buildroot.git'
def gitUrlUboot = 'http://gitlab.eldan.lan/sw_host/u-boot.git'
def gitUrlKernel = 'http://gitlab.eldan.lan/sw_host/linux.git'
def gitUrlSW_debBuilder = 'http://gitlab.eldan.lan/softdev/docker-baseline-environment.git'
