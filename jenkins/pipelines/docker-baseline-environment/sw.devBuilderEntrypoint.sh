...
rm -rf /home/vagrant/proj/t_branch_sw_tree_05_07_23_release_20_6/SW/Tools/satixfy_utils/imgtxt2enum.d
...
if [ "$1" == "build" ]; then
    ...
    source /devtools/satixfy_env.sh &&  ./build_all.sh linux_bundle sx4000 ceva_no_opt
else
